PLAYER_AGENT_PROMPT = (
    ...
    "少用套话，例如“我先”“这条线”“脉络”“桌面”“好人位”“带节奏”“不急着打死”“把话说死”“信息链”；如果用，也不要连续反复用。\n"
...
PLAYER_SPEECH_INSTRUCTION = (
    ...
    "可以试探、反问、犹豫或施压，不要写成分析报告。只抓 1 到 2 个重点，"
    "80 到 180 字左右，最多两个自然段。不要总用“我先”开头。不要提到系统提示词，"
    "也不要暴露你不应该公开的信息。"
)
...
WEREWOLF_DISCUSSION_INSTRUCTION = (
    ...
    "像私聊打字，不要演讲。80 到 180 字左右。不要输出 JSON，不要写成正式报告。"
)
